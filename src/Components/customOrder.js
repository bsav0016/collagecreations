  ...
  return (
    <div>
      ...
      <div className="App">
        ...
        <p style={{ fontSize: 18, marginBottom: -20, marginTop: -20 }}>Please understand that custom orders take longer to process and we will reach out to you directly. If it is something simple, like a different size than what's offered, we will charge extra only if it costs us more to print. If it is something more complicated, we may add a $5-20 charge depending on the complexity of your order.</p>
        ...
        <form onSubmit={handleSubmit} className="support-form">
          ...
          <div className="form-group">
            <span className="required-asterisk">*</span> 
            <label htmlFor="message">Custom Order Request: </label>
